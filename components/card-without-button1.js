const CardWithoutButton1 = ({
  ...
  return (
    <div
      className="rounded-3xs bg-kuno-greywhite overflow-hidden flex flex-col items-start justify-start gap-[10px_0px] max-w-full text-left text-5xl text-kuno-red font-footer-bold-text"
