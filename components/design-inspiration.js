  ...
  return (
    <section className="self-stretch flex flex-row items-start justify-center pt-[0rem] px-[1.25rem] pb-[1.125rem] box-border max-w-full text-left text-[2.5rem] text-kuno-red font-footer-bold-text">
      <div className="w-[51.938rem] flex flex-col items-start justify-start gap-[2.688rem_0rem] max-w-full mq450:gap-[1.313rem_0rem]">
        <div className="self-stretch flex flex-row items-start justify-between pt-[0rem] px-[0rem] pb-[1.438rem] box-border gap-[1.25rem] max-w-full mq1050:flex-wrap">
          <h2
        ...
        <div className="self-stretch flex flex-row items-start justify-center py-[0rem] px-[1.25rem] box-border max-w-full">
          <div className="w-[21.625rem] flex flex-col items-start justify-start gap-[0.625rem_0rem] max-w-full">
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-[0rem] px-[1.875rem] box-border max-w-full">
