    ...
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-center justify-start pt-5 px-0 pb-[30px] box-border gap-[10px_0px] tracking-[normal]">
        ...
        <div className="flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-3 box-border min-w-[473px] max-w-full mq750:min-w-full">
          <div className="self-stretch flex flex-col items-center justify-start gap-[20px_0px]">
            <div className="self-stretch flex flex-col items-start justify-start gap-[8px_0px]">
              ...
              <h1 className="m-0 w-[727px] relative text-21xl font-bold font-inherit inline-block mq750:text-13xl mq450:text-5xl">
                <p className="m-0">Mastering Construction Design:</p>
                <p className="m-0">Building Tradition's Signature Approach</p>
              </h1>
              <div className="w-[727px] relative text-base text-justify inline-block">
                <p className="m-0">
      ...
      <section className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[27px] box-border max-w-full text-left text-21xl text-kuno-red font-footer-bold-text">
        ...
        >
          ...
          <div className="self-stretch bg-white overflow-hidden flex flex-row items-center justify-center py-2.5 px-0 box-border gap-[0px_100px] max-w-full text-5xl mq750:gap-[0px_100px] mq450:gap-[0px_100px] mq1225:flex-wrap">
            ...
            <div className="w-[562px] overflow-x-auto shrink-0 flex flex-col items-start justify-center p-5 box-border gap-[18px_0px] min-w-[562px] max-w-full mq750:min-w-full mq1225:flex-1">
      ...
      <section className="flex flex-col items-center justify-start pt-0 px-5 pb-[17px] box-border gap-[30px_0px] max-w-full text-left text-21xl text-kuno-red font-footer-bold-text">
        ...
        <div className="w-[1288px] relative text-base text-justify inline-block">
